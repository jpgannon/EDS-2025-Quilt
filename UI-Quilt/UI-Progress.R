             ...
             p(
               ...
               tags$p("Tab 3: View & Share",
                      helpText("This tab allows you to preview your quilt design with the data you selected to show,
                               ...
                               desired. The slider also allows you to change the thickness of the border if you choose to add one. 
                               The 'share your design' button can be used to share your design on social media, on Pinterest, 
                               Twitter (X), or Facebook. The right hand side of this page is where your quilt design preview will 
                               appear! The hex codes with color swatches are shown
